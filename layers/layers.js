...
var format_Roads_final_5 = new ol.format.GeoJSON();
var features_Roads_final_5 = format_Roads_final_5.readFeatures(json_Roads_final_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Roads_final_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Roads_final_5.addFeatures(features_Roads_final_5);
var lyr_Roads_final_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Roads_final_5, 
                style: style_Roads_final_5,
                interactive: true,
    title: 'Roads_final<br />\
    <img src="styles/legend/Roads_final_5_0.png" /> Major Roads<br />\
    <img src="styles/legend/Roads_final_5_1.png" /> State Highway <br />\
    <img src="styles/legend/Roads_final_5_2.png" /> National Highway<br />'
        });

lyr_OpenStreetMap_0.setVisible(true);lyr_SatelliteImagery_1.setVisible(true);lyr_Esri_topolayer_2.setVisible(true);lyr_revenueboundary_3.setVisible(true);lyr_floodproneVillages_4.setVisible(true);lyr_Roads_final_5.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_SatelliteImagery_1,lyr_Esri_topolayer_2,lyr_revenueboundary_3,lyr_floodproneVillages_4,lyr_Roads_final_5];
...
lyr_Roads_final_5.set('fieldAliases', {'name': 'name', 'ref': 'ref', 'type': 'type', });
...
lyr_Roads_final_5.set('fieldImages', {'name': 'TextEdit', 'ref': 'TextEdit', 'type': 'TextEdit', });
...
lyr_Roads_final_5.set('fieldLabels', {'name': 'inline label', 'ref': 'no label', 'type': 'inline label', });
lyr_Roads_final_5.on('precompose', function(evt) {
